  ...
  return ( 
   ...
   <BackDrops/>
    <div className=" pt-24 min-h-screen"> 
        <main className="mx-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-28 lg:pb-8 ">
            <div className="grid lg:grid-cols-[400px_1fr] gap-8">
                {/*Left Panel */} 
                <div className={`space-y-6 ${id && 'pointer-events-none'}`}>
                    <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6 ">
                        <div>
                            <h2 className="text-xl font-bold text-white">Create Stunning Thumbnails</h2>
                            <p className="text-sm  text-gray-400">Enter the details for your content generation.</p> 
                        </div>
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <input type="text" value={title} onChange={(e)=>setTitle(e.target.value)} maxLength={100}
                                 placeholder="e.g. Build Thumbnail using AI" className="w-full px-4 py-3 rounded-lg border border-white/12 bg-black/20
                            ...
                            className="w-full px-4 py-3 rounded-lg border border-white/12 bg-black/20
                                 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-pink-500 mt-2 resize-none"/>
                            </div>

                        </div>
                        {/* button */}
                        { !id && (
                            <button onClick={handleGenerate} className="text-sm w-full py-2.5 rounded-xl 

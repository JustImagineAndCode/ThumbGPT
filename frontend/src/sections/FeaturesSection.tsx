    ...
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                   Skyrocket your YouTube views and CTR with high-converting AI thumbnail designs.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Thumbnails Engineered to Maximize YouTube Views </h3>
                        <p className="text-slate-300 mt-2">ThumbGPT empowers you to create viral-ready designs and scale your channel effortlessly.</p>
                        <a href="https://prebuiltui.co" className="group flex items-center gap-2 mt-4 text-pink-600 hover:text-pink-700 transition">
